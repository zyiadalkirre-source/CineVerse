...
class CustomDrawer extends StatelessWidget {
  ...
  static const _items = <({
    ...
    (icon: Icons.local_fire_department_rounded, title: 'اخر التحديثات'),
    (icon: Icons.list_alt_rounded, title: 'لائحة الانمي'),
    (icon: Icons.calendar_month_rounded, title: 'المواسم'),
    (icon: Icons.bar_chart_rounded, title: 'التقييم العالمي'),
    (icon: Icons.bar_chart_rounded, title: 'التقييم العربي'),
    (icon: Icons.bar_chart_rounded, title: 'قائمتي'),
    ...
    (icon: Icons.history_rounded, title: 'اخر المشاهدات'),
    (icon: Icons.download_rounded, title: 'تحميلاتي'),
    (icon: Icons.bar_chart_rounded, title: 'الشخصيات الاكثر شعبية'),
    (icon: Icons.extension_rounded, title: 'التوصيات'),
    (icon: Icons.event_rounded, title: 'مواعيد نزول الحلقات'),
    (icon: Icons.settings_rounded, title: 'الاعدادات'),
  ];
