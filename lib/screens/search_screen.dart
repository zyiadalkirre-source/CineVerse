...
class _SearchScreenState extends State<SearchScreen>{
  ...
  Future<void> go()async{
    ...
    try{
      results=await context.read<MediaProvider>().search(query,'ar');
    }catch(e){
        ...
        Padding(
          ...
          child:TextField(
            ...
            decoration:InputDecoration(
              ...
              suffixIcon:IconButton(onPressed:go,icon:const Icon(Icons.search)),
            ),
          ),
        ),
            ...
            itemBuilder:(_,i){
              ...
              return InkWell(
                onTap:()=>Navigator.push(
                  context,MaterialPageRoute(builder:(_)=>DetailScreen(item:x))),
