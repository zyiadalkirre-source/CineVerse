...
Future<void> main() async{WidgetsFlutterBinding.ensureInitialized();await CacheService.init();await ApiConfig.init();await NotificationService.init();runApp(const CineVerseApp());}
